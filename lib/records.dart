...
class MyRecords extends StatefulWidget {
  final String? temp;
  int petdex;
  MyRecords({Key? key, required this.petdex, required this.temp}) : super(key: key);

  //@override
  @override
  State<MyRecords> createState() => _MyRecordsState(this.petdex, this.temp.toString());
}
...
class _MyRecordsState extends State<MyRecords> {
  ...
  _MyRecordsState(this.petdex, this.temp);
